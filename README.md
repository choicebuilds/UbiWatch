...
### This watch is entirely built from scratch. A significantly improved version of [BumWatch][BW]!

*insert picture(s) here*

Designed using Altium Designer  
Fabricated through JLCPCB  
Firmware written using nRF Connect  
Chassis 3D-printed at TBD
